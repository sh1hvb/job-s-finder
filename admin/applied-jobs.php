...
if (isset($_POST['reject'])) {
    $id = $_GET['id'];
    $con = mysqli_connect("localhost", "root", "", "placement") or die('problem');
                            ...
                            <div class="thumbnail" style="width: auto;">
                                ...
                                <div class="caption">
                                    ...
                                    <p class="flex-text text-muted">
                                        ...
                                        <br><strong>Student
                                            Name:
                                        </strong> <?php echo $row['studentfname'] . " " . $row['studentlname']; ?>
                                    ...
                                    <h4><strong>Status: </strong><?php echo $row['status']; ?>
                                        <form method="post" action="applied-jobs.php?id=<?php echo $row['id'] ?>">
                                            <button class="btn btn-success" type="submit" name="accept">Accept Job
                                            </button>
                                            <button class="btn btn-danger pull-right" type="submit" name="reject">Reject
                                                Job
                                            </button>
                                        </form>
                                </div>
