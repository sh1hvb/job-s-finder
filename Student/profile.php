...
<section>
    ...
    <div style="width: 100%; height: auto;">
        ...
        <div class="mainpage">
            ...
            <div class="main">
                <em style="color: rgb(0,0,0,0.5);border-radius: 0px 5px 5px 0px;padding: 8px;position: absolute;margin: 233px 0 0 479px;z-index: 1;"
                    class="fa fa-eye pull-right" id="eye"></em>
                        ...
                        <div class="col-md-6 latest-job ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control input-sm" id="password" name="password"
                                       placeholder="Password" value="<?php echo $_SESSION['password'] ?>">
                            </div>

                            <div class="form-group">
                                <label for="address">Address</label>
                                <textarea id="address" name="address" class="form-control input-sm" rows="5"
                                          placeholder="Address"><?php echo $_SESSION['address'] ?></textarea>
                            </div>

                            <div class="form-group">
                                <label for="city">City</label>
                                <input type="text" class="form-control input-sm" name="city"
                                       value="<?php echo $_SESSION['city'] ?>" placeholder="city">
                            </div>
                        ...
                        <div class="col-md-6 latest-job ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-sm" name="contact"
                                       placeholder="Contact Number" value="<?php echo $_SESSION['contact'] ?>">
                            </div>

                            <div class="form-group">
                                <label for="qualification">Highest Qualification</label>
                                <input type="text" class="form-control input-sm" name="qualification"
                                       placeholder="Highest Qualification"
                                       value="<?php echo $_SESSION['qualification'] ?>">
                            </div>

                            <div class="form-group">
                                <label for="stream">Stream</label>
                                <input type="text" class="form-control input-sm" name="stream" placeholder="Stream"
                                       value="<?php echo $_SESSION['stream'] ?>">
                            </div>

                            <div class="form-group">
                                <label>Skills</label>
                                <textarea class="form-control input-sm" rows="2" name="skills"
                                          placeholder="Skills"><?php echo $_SESSION['skills'] ?></textarea>
                            </div>

                            <div class="form-group">
                                <label>About Me</label>
                                <textarea class="form-control input-sm" rows="4" name="about"
                                          placeholder="About me"><?php echo $_SESSION['about'] ?></textarea>
                            </div>

                            <div class="form-group">
                                <label for="state">State</label>
                                <input type="text" class="form-control input-sm" name="state" placeholder="state"
                                       value="<?php echo $_SESSION['state'] ?>">
                            </div>

                            <div class="form-group" style="float:right;">
                                <button type="submit" name="update" class="btn btn-flat btn-success">Update Profile
                                </button>
                            </div>
